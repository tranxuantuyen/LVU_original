...
def load_mc_video_data(args, evaluate):
    with open(f'/home/s222126678/Documents/lvu_trans/data/instance_meta/instance_meta_{args.long_term_task_name}.pkl', 'rb') as fin:
    ...
    for split in (['val', 'test'] if evaluate else ['train']):
        with open(f'/home/s222126678/Documents/lvu_trans/data/lvu_1.0/{args.long_term_task_name}/{split}.csv', 'r') as f:
            f.readline()
            for line in f:
